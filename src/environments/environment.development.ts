...
import {
  ...
  ANGULAR_APP_STRIPE_SK,
  ENABLE_CAPTCHA,
  PRODUCTION
} from '@greda/common-config/portfolio-portal/local/environment'
import {ANGULAR_APP_USER_EMAIL} from '@greda/common-config/portfolio-portal/prd/environment';
